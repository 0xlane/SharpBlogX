...
namespace SharpBlogX.Admin.Pages
{
    public partial class Index
    {
        ...
        {
            var statisticsResponse = await GetResultAsync<BlogResponse<Tuple<int, int, int>>>("api/blog/statistics");
            ...
            var healthResponse = await GetResultAsync<BlogResponse<List<NameValue>>>("api/health");
