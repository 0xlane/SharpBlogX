...
namespace SharpBlogX.Admin.Pages.Posts
{
    public partial class PostEdit
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            var response = await GetResultAsync<BlogResponse<PostDto>>($"api/blog/post/{postId}");
        ...
        public async Task OnToolbarButtonClick(string name)
        {
            ...
            var categoryResponse = await GetResultAsync<BlogResponse<List<GetAdminCategoryDto>>>("api/blog/admin/categories");
            var tagResponse = await GetResultAsync<BlogResponse<List<GetAdminTagDto>>>("api/blog/admin/tags");
        ...
        public async Task HandleSubmit()
        {
            ...
            var response = await GetResultAsync<BlogResponse>($"api/blog/post/{postId}", json, HttpMethod.Put);
            if (response.Success)
            {
